...
1. Clone the repository: `git clone https://github.com/YourUsername/cinema-assistant-android.git`
2. Go to [Google Cloud Console](https://console.cloud.google.com/) and create a new project.
3. Enable the **Gmail API**.
4. Configure the **OAuth Consent Screen** and add your testing email addresses to the "Test users" list.
5. Create OAuth 2.0 Client IDs for Android and download the `credentials.json` (ensure this is kept out of version control).
6. Build and run the app in Android Studio.
